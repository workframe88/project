...
<!-- start-->
  <div class="panel panel-primary" style="margin-top: 100px">
            ...
            <h3 class="panel-title"><h1>แก้ไขข้อมูลส่วนตัว</h1></h3>
          </div>
...
<td><center><a href="displaymember.php"><span class="glyphicon glyphicon-arrow-left" aria-hidden="true" style="margin:10px"></span></a></center></td>
</form>
          </div>
          </div>
  <!--end-->
