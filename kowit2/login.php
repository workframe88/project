...
if (isset($_POST['Username'])) {
  ...
  $MM_redirectLoginSuccess = "win.php";
  $MM_redirectLoginFailed = "lose.php";
...
<form id="form1" name="form1" method="POST" action="<?php echo $loginFormAction; ?>">
  <table width="32%" border="0" align="center">
    <tr>
      <td colspan="2" align="center"><h3><strong>เข้าสู่ระบบ</strong></h3></td>
    </tr>
    <tr>
    ...
    <tr>
      <td colspan="2" align="center"><a href="register.php">สมัครสมาชิกใหม่</a></td>
    </tr>
  </table>
</form>
</body>
