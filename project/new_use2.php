		  ...
		  console.log("-------------"+data.length);
		  	if(data.length == 4){
		  		if(data == pin){
		  			...
		  			window.location.href = "save_use.php?tel=" + tel + "&pin=" + pin + "&time=" + time + "&point=" + point;
		  		}else{
		  			data = document.getElementById("txt").value = "รหัสไม่ตรง";
		  		}
...
<body style="background-color: #ADFF2F">
	<form action="new_use.php" method="get">
	<?php
		if($point == 1){
	?>
