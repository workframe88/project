		  	...
		  	if(data.length == 4){
		  		if(data == pin){
		  			if("0000000000" == tel){
		  				...
		  				window.location.href = "welcome.php?tel=" + tel +"&point=" +point + "&time=" + time;
		  			}
		  			
		  		}else{
		  			data = document.getElementById("txt").value = "รหัสผิดพลาด";
		  		}
...
?>	
	...
	<input type="text" name="tel" value="<?php echo $tel ;?>" id="tel" hidden="true">
	<input type="text" name="pin" value="<?php echo $pin ;?>" id="pin" hidden="true">
...
font-family: 'Mochiy Pop One', sans-serif;
font-family: 'Prompt', sans-serif;">ยืนยัน PIN 4 หลัก</h1>
<br><br>
...
<table border="0" style="margin-top: 30px">
	...
	?>
			<button class="btn btn-secondary" type="submit" style="font-size: 45px;width: 95px;height: 95px;border-radius: 50px;">
...
<a href="menu.php" class="btn btn-secondary" type="button" style="font-size: 45px;width: 95px;height: 95px;border-radius: 50px;">
				<svg xmlns="http://www.w3.org/2000/svg" width="50" height="50" fill="currentColor" class="bi bi-x-circle" viewBox="0 0 16 16">
  <path d="M8 15A7 7 0 1 1 8 1a7 7 0 0 1 0 14zm0 1A8 8 0 1 0 8 0a8 8 0 0 0 0 16z"/>
  <path d="M4.646 4.646a.5.5 0 0 1 .708 0L8 7.293l2.646-2.647a.5.5 0 0 1 .708.708L8.707 8l2.647 2.646a.5.5 0 0 1-.708.708L8 8.707l-2.646 2.647a.5.5 0 0 1-.708-.708L7.293 8 4.646 5.354a.5.5 0 0 1 0-.708z"/>
</svg>
...
?>	
		...
		<td style="padding: 5px"> <button type="button" id="del" onclick="del2()" style="font-size: 25px;width: 95px;height: 95px;border-radius: 50px;" class="btn btn-secondary"><svg xmlns="http://www.w3.org/2000/svg" width="50" height="50" fill="currentColor" class="bi bi-backspace-fill" viewBox="0 0 16 16">
